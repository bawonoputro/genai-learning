...
# Load data
df_descriptions = pd.read_csv(PROJECT_ROOT / 'data' / 'steam_description_data.csv')
df_games = pd.read_csv(PROJECT_ROOT / 'data' / 'steam.csv')
...
corpus_embeddings = torch.from_numpy(np.load(PROJECT_ROOT / 'embeddings.npy')).to(device)
